...
from .matplotlib_forecasts import (
    forecast as mpl_forecast,
    forecast_stats as mpl_forecast_stats,
    forecast_ensembles as mpl_forecast_ensembles
)
from .matplotlib_retrospective import (
    retrospective as mpl_retrospective,
    daily_averages as mpl_daily_averages,
    monthly_averages as mpl_monthly_averages,
    annual_averages as mpl_annual_averages
)
...
def forecast(df: pd.DataFrame, *,
             ...
             plot_titles: list = None, ) -> go.Figure or plt.subplots:
    """
